          ...
          >
            ...
            {msg.role === "user" ? (
              ...
              <div className="text-sm leading-relaxed prose prose-sm max-w-none prose-p:leading-relaxed prose-p:my-0 prose-pre:my-0">
                <ReactMarkdown
                  components={{
                    p: ({ node: _n, ...props }) => <p className="mb-0 last:mb-0" {...props} />,
                    ul: ({ node: _n, ...props }) => <ul className="list-disc ml-4 my-2" {...props} />,
                    ol: ({ node: _n, ...props }) => <ol className="list-decimal ml-4 my-2" {...props} />,
                    li: ({ node: _n, ...props }) => <li className="my-1" {...props} />,
