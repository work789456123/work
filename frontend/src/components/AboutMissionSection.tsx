...
import PawTexture from "./PawTexture";
...
export default function AboutMissionSection() {
	...
	return (
		<section id="about-mission" className="bg-white relative py-20 md:py-28">
			{/* Decorative elements */}
			<PawTexture/>
			<div className="pointer-events-none absolute inset-0" aria-hidden>

				<Image
					src="/images/cow&goat.png"
					alt=""
					className="block absolute left-0 top-4"
					width={300}
					height={300}
				/>
				{/* <Image
					src="/images/tr_wave.png"
					alt=""
			...
			<div className="mx-auto max-w-5xl px-6 relative z-10">
				<div className="mb-14 text-center">
					...
					>
						...
						<span className="font-semibold text-[#1F6559]">
							{aboutMission.leadHighlight}
						</span>
					...
					{aboutMission.pillars.map((item, i) => {
						...
						return (
							...
							>
								...
								<span className="heading-font text-sm font-semibold text-[#333]">
									{item.text}
								</span>
							</motion.div>
						);
