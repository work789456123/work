...
export function useScrollMotion() {
  ...
  const t = (base: Transition): Transition => (reduced ? { duration: 0 } : base);
  const stagger = reduced ? 0 : 0.11;
  const delayChildren = reduced ? 0 : 0.06;
  return { reduced, t, stagger, delayChildren };
}

export const staggerContainer = (stagger: number, delayChildren: number): Variants => ({
  hidden: {},
  visible: {
...
export const fadeUp = (transition: Transition): Variants => ({
...
export const fadeIn = (transition: Transition): Variants => ({
  hidden: { opacity: 0 },
  visible: {
    opacity: 1,
    transition,
...
export const slideInRight = (transition: Transition): Variants => ({
...
export const slideInLeft = (transition: Transition): Variants => ({
...
export const scaleIn = (transition: Transition): Variants => ({
