...
import { useRef, useEffect, useCallback, useReducer, type ChangeEvent } from "react";
...
import type { TermsConsentKey } from "@/types/terms-consent";

const THRESHOLD = 10;

function isTermsConsentKey(name: string): name is TermsConsentKey {
  return Object.prototype.hasOwnProperty.call(termsConsentInitialState.consents, name);
}
...
export default function TermsAndConditions() {
  ...
  const handleCheckboxChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    if (!isTermsConsentKey(name)) return;
                  ...
                  >
                    <div className="flex items-center h-6 mt-0.5">
                      <input
                        ...
                        type="checkbox"
                        name={item.name}
                        checked={consents[item.name as TermsConsentKey]}
