...
export default function AboutStorySection() {
	...
	return (
		<section id="about-story" className=" bg py-20 relative md:py-28">
			<div className="bg-[url(/images/bg_story.png)] absolute inset-0 opacity-40 bg-c"></div>
			<div className="mx-auto max-w-7xl px-6 relative z-10">
				...
				>
					...
					<motion.p
						variants={fadeUp(tr)}
						className="text-xl leading-relaxed text-[#6F6F6F]"
					>
						{aboutStory.lead}
					</motion.p>
				</ScrollReveal>
					...
					>
						{aboutStory.leftColumn.map((para, i) => (
							<motion.p
								key={i}
								variants={fadeUp(tr)}
								className="text-lg leading-relaxed text-[#6F6F6F]"
							>
								{para}
							</motion.p>
						))}
					...
					>
						{aboutStory.highlightCards.map((card, i) => (
							...
							>
								...
								<h3 className="heading-font mb-2 text-base font-semibold text-[#333]">
									{card.title}
								</h3>
