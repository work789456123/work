...
import {
	surakshaPage,
	surakshaPlans,
} from "@/assets/content/pashucare_suraksha_plan";
...
const PashuCareSurakshaPlan = () => {
	...
	return (
		<UserPageShell
			...
			className="min-h-screen bg-teal-50 relative py-12"
		...
		>
			...
			<div id="suraksha-inner" className="max-w-6xl mx-auto px-6 relative">
						...
						return (
							...
							>
								...
								<div className="text-center space-y-2">
									...
									/>
									<h3 className="heading-font text-2xl font-bold text-[#333]">
										{plan.name}
									</h3>
				...
				<div
					id="suraksha-how-it-works"
					className="bg-teal-50 rounded-2xl border border-[#EAEAEA] p-8 mb-16"
				>
					<h2
						id="suraksha-how-it-works-title"
						className="heading-font text-2xl font-bold text-[#333] text-center mb-8"
					>
				...
				<div
					id="suraksha-promo-cta"
					className="bg-gradient-to-r from-[#1F6559] to-[#2ba896] rounded-2xl p-8 text-white text-center space-y-4"
				>
