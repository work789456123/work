...
const OurStory = () => {
	...
	return (
		<UserPageShell id="page-our-story" className="min-h-screen">
			{/* ── Hero ─────────────────────────────────────────────── */}
			<PageTitle id="our-story-hero">
				<div className="relative mx-auto max-w-3xl px-6 text-center">
					...
					<motion.p
						className="heading-font mx-auto mt-5 max-w-xl text-xl font-semibold text-[#1F6559]"
			...
			{/* ── Founders ─────────────────────────────────────────── */}
			<section
				id="our-story-founders"
				className="bg-teal-100/75 relative py-20 md:py-28"
			>
				<PawTexture />
							...
							return (
								<div key={founder.name}>
										...
										>
											<motion.div variants={fadeUp(tr)} className="space-y-1">
												...
												<SplitHeading
													...
													wordDelay={0.09}
												/>
												<p className="text-base font-semibold text-[#1FA7A6] md:text-lg">
													{founder.role}
												</p>
											</motion.div>
									...
									{idx === 0 && (
										...
										>
											<div
												className="pointer-events-none absolute -right-16 -top-16 h-64 w-64 rounded-full bg-[#38C2B4]/20 blur-3xl"
												aria-hidden
											/>
											<div
												className="pointer-events-none absolute -bottom-12 left-8 h-48 w-48 rounded-full bg-[#78D65C]/15 blur-3xl"
												aria-hidden
											/>
											...
											<div className="relative mx-auto max-w-4xl space-y-7 text-center">
												...
												>
													...
													>
														<Quote
															className="mb-3 h-6 w-6 text-[#78D65C]"
															aria-hidden
															strokeWidth={1.5}
														/>
														<p className="text-lg leading-relaxed text-white/95">
															{q.villageStory.before}
															<span className="font-bold text-[#78D65C]">
																{q.villageStory.emphasis}
															</span>
