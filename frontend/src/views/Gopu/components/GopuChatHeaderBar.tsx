    ...
    >
      ...
      <div className="flex items-center gap-3">
        <select
          ...
          className="text-xs border border-teal-200 rounded-full px-3 py-1.5 bg-white text-[#1F6559] focus:outline-none focus:ring-1 focus:ring-teal-500 cursor-pointer font-medium"
        >
