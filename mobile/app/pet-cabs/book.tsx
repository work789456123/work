...
const styles = StyleSheet.create({
  ...
  travelCard: { backgroundColor: 'rgba(255,255,255,0.85)', borderRadius: 12, padding: 14, width: 130, alignItems: 'center', borderWidth: 1, borderColor: '#e5e7eb', elevation: 1 },
  ...
  packageCard: { backgroundColor: 'rgba(255,255,255,0.85)', borderRadius: 12, width: 200, borderWidth: 1, borderColor: '#e5e7eb', elevation: 1, overflow: 'hidden' },
  ...
  section: { backgroundColor: 'rgba(255,255,255,0.85)', borderRadius: 12, marginHorizontal: 16, marginBottom: 12, padding: 16, elevation: 1 },
  ...
  modalBox: { backgroundColor: 'rgba(255,255,255,0.85)', borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 20, maxHeight: '90%' },
